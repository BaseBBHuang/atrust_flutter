...
FOUNDATION_EXPORT SFAuthKeyName const kAuthKeyAuthReBindFlag;     // 授信终端申请解绑列表
...
FOUNDATION_EXPORT SFOptionsName const kOptionsNotHookWebview;           // 不hook webview
FOUNDATION_EXPORT SFOptionsName const kOptionsNotInjectAjaxJS;          // 不注入ajax js
FOUNDATION_EXPORT SFOptionsName const kOptionsHookNSURLConnection;      // hook NSURLConnection
FOUNDATION_EXPORT SFOptionsName const kOptionsNotHookNSURLProtocol;     // 不hook NSURLProtocol
FOUNDATION_EXPORT SFOptionsName const kOptionsNotHookHandlesURLScheme;  // 不hook HandlesURLScheme
FOUNDATION_EXPORT SFOptionsName const kOptionsUsingWebsocketExtension;  //websocket不清除Sec-WebSocket-Extensions字段
...
typedef NS_ENUM(NSInteger, SFSDKOption)
{
    ...
    SFSDKOptionNotHookWebview            = 7,            //不hook webview
    SFSDKOptionNotInjectAjaxJS           = 8,            //不注入ajax js
    SFSDKOptionHookNSURLConnection       = 9,            //hook NSURLConnection
    SFSDKOptionNotHookNSURLProtocol      = 10,           //不hook NSURLProtocol
    SFSDKOptionNotHookHandlesURLScheme   = 11,           //不hook HandlesURLScheme
    SFSDKOptionUsingWebsocketExtension   = 15,           //websocket不清除Sec-WebSocket-Extensions字段
};
...
typedef NS_ENUM(NSInteger, SFSDKExtras)
{
    ...
    SFSDKExtrasDNSCacheTTL               = 3,            //DNS缓存设置的TTL(非资源域名生效，单位S)
    SFSDKExtrasDisableReportData         = 4,            //禁用数据上报
};
...
typedef NS_ENUM(NSInteger, SF_ERROR_CODE)
{
    ...
    SF_ERROR_CONNECT_RESCUE                   = 2009,        //逃生错误
    ...
    SF_ERROR_TERMINAL_HAS_TRUSTED_REBIND_FAILED = 75500311, //重新绑定时超限
} ;
